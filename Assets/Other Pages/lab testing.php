...
?>
    <div class="hover" id="div1">
        <h2 class="mb-4" style="font-family:Arial, Helvetica, sans-serif;font-weight:400;letter-spacing:2px;">TESTING <?=$row['prod_name']?> </h2>
        </div>
        <br>
  <h3>PRODUCT NAME: </h3>
  <h5><?=$row['prod_name']?></h5>
...
?>
<tr><form action="dataaccess.php?id=<?=$ID?>" method="post"><input class="btn btn-outline-info" type="submit" name="btn_done" value="DONE" style="width:100%;" /></form></tr>
</tbody>
</table>
      </div>
		</div>
